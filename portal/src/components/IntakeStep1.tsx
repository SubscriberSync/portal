...
export default function IntakeStep1({ 
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <h3 className="font-semibold text-slate-200">Step 1: Connect Your Systems</h3>
              <p className="text-sm text-emerald-400">✓ All credentials approved</p>
            </div>
          </div>
  ...
  return (
    <div className="bg-slate-800/50 rounded-2xl border border-slate-700/50 overflow-hidden">
      {/* Header */}
      <div 
        className={`p-5 border-b border-slate-700/50 ${allApproved ? 'cursor-pointer hover:bg-slate-800/30' : ''}`}
      ...
      >
                ...
                return (
                  <div 
                    ...
                    className={`w-2 h-2 rounded-full transition-colors ${
                      ...
                      sub?.status === 'Submitted' ? 'bg-amber-400' :
        ...
        {!allApproved && (
          <div className="mt-4 h-1.5 bg-slate-700/50 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-copper to-amber-500 transition-all duration-500 rounded-full"
